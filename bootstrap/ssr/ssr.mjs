...
default_1((page) => createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(
    `./Pages/${name}.vue`,
    /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword.e531d54d.mjs"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword.2cc77927.mjs"), "./Pages/Auth/Login.vue": () => import("./assets/Login.0be3a8b5.mjs"), "./Pages/Auth/Register.vue": () => import("./assets/Register.3c3075bc.mjs"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword.2b0103be.mjs"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail.792e7c74.mjs"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard.9305d176.mjs"), "./Pages/Landing/Home.vue": () => import("./assets/Home.e488c030.mjs"), "./Pages/Welcome.vue": () => import("./assets/Welcome.bafed7ae.mjs") })
  ),
  setup: ({ app: app2, props, plugin }) => {
    return createSSRApp({ render: () => h$1(app2, props) }).use(plugin).use(I, Ziggy);
  }
}));
